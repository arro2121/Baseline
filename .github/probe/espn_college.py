...
S = "https://site.api.espn.com/apis/site/v2/sports/"
def board(path, q):
...
for path in ("football/college-football", "basketball/mens-college-basketball"):
    d = get(f"https://site.api.espn.com/apis/v2/sports/{path}/standings"); print("-- standings", path, d.get("_err"), [c.get("name") for c in d.get("children", [])][:40])
